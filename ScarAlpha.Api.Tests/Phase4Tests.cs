...
/// <summary>Pending approval factory — connected but not approved.</summary>
public sealed class PendingApprovalApiFactory : WebApplicationFactory<Program>
{
    ...
    internal static void ConfigureTestDbAndBinolla(IServiceCollection services)
    {
        ...
        mgr.Setup(m => m.GetOrCreateAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((string uid, string _, CancellationToken _) => { connected[uid] = 1; return client.Object; });
